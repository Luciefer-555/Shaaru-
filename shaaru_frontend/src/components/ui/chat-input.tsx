	...
	return (
		<ChatInputContext.Provider value={contextValue}>
			<div
				className={cn(
					variant === "default" &&
						"flex flex-col w-full p-2 rounded-3xl bg-glass-bg backdrop-blur-xl border border-glass-border shadow-lg transition-all duration-300 focus-within:border-white/20 focus-within:shadow-[0_8px_32px_rgba(255,26,64,0.15)] focus-within:bg-white/5",
